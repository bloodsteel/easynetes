<template>
	<!-- 卡片 https://arco.design/vue/component/card  :bordered="false" 是否有边框 -->
	<a-card :bordered="false">
		<a-space :size="54">
			<!-- 头像上传 https://arco.design/vue/component/upload -->
			<!-- :custom-request 自定义上传行为 -->
			<a-upload
			...
			<!-- 描述列表 https://arco.design/vue/component/descriptions -->
			<a-descriptions
				:data="renderData"
				:column="2"
				align="right"
