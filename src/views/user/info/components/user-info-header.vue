<template>
  <div class="header">
    <!-- 间距 https://arco.design/vue/component/space   align对齐方式 direction间距方向 -->
    <a-space :size="12" direction="vertical" align="center">
      <!-- 头像 https://arco.design/vue/component/avatar  size表示头像的大小单位是px -->
      <a-avatar :size="64">
      ...
      <!-- 排版 https://arco.design/vue/component/typography -->
